...
rollup:
  ...
  genlayerchainwebsocketurl: "BURAYA_BRADBURY_WEBSOCKET_URL_YAZ"
  provider: "caldera"

# Testnet Bradbury Phase 1 — consensus configuration
consensus:
...
[Unit]
Description=GenLayer Validator Node — Testnet Bradbury
